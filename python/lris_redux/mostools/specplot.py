...
class SpecPlot:
	...
	def __init__(self,file):
		...
		"""
		self.linelist = [2344,2374,2383,2587,2599.4,2750.3,2795.,2802.7,2852,3727.,3835.38,3889.05,3933.66,3968.47,4101.74,4305.,4340.47,4861.33,4962.,5007.,5177.,5270.,5891.9,6562.8,6583.5,6716.4,6730.8]
		self.linename = ['Fe','','Fe','Fe','','FeII','','MgII','MgI',"[OII]",'Heta','','CaK','CaH','H-delta','Gband','H-gamma','H-beta','OIII','OIII','Mgb','Fe','NaII','H-alpha','N','S','']
