...
ow,s,v = extract('EEL_J1125+3058',[45,46,47],loc=[57,92,25],wid=2)
ow = ow[:-33][5::10]
s = numpy.sort(s[:-33].reshape((2*1330,10)),1)[:,3:-3].sum(1)
pylab.plot(10**ow,s,'k')

ww = st.wavelength('/home/mauger/spSpec-53431-1979-047.fit')
dd = pyfits.open('/home/mauger/spSpec-53431-1979-047.fit')[0].data
pylab.plot(ww,ndimage.uniform_filter(dd[0],7)/4-0.4,'r')
